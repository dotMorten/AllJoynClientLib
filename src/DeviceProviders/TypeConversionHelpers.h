...
internal:
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ Platform::Object^ value)
    {
		...
		//{
		//	if(signature[0] == 118)
		//		return SetAllJoynMessageArgHelper(argument, "v", signature, nullptr);
		//}
		...
		auto variantValue = dynamic_cast<DeviceProviders::AllJoynMessageArgVariant^>(value);
		if (variantValue != nullptr)
		{
			return SetAllJoynMessageArgHelper(argument, "v", signature, variantValue);
		}
